/* Template Factory - PS Electrical live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-ps-corona/';
  var LS_CHANGES = 'tf_ps_change_log_v1';
  var LS_PURCHASED = 'tf_ps_purchased_v1';
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for PS Electrical. Hang tight.',
        delay,
        function () {
