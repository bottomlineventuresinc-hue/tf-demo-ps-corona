# Site customization checklist · PS Electrical (hs-022-ps)
Wave 5 · Copperline · claim/$297 + hosting/$99 bar required. Rebuilt 2026-09-25 (CR 2026-09-25b, CEO change request).

Before preview send:
- [x] Business name everywhere (title, wordmark, footer, schema)
- [x] City / service area
- [x] Phone click-to-call is the main CTA (tel-only; no public email)
- [x] Address per packet (FARM-PACKETS-WAVE5.md)
...
Owner first name in human spots: Paul
NAP/phone per packet: 1191 Magnolia Ave, Corona CA 92879 · 714-308-0696
lang: en-US · geo: CA
...
Locked lead-specific corrections kept: none beyond hours (Call for hours) and wordmark-only logo
Lead notes: pselectric.com and pselectrical.com are landers or for sale, not owned by the lead, NOT linked or offered. No license number on page.
Prior folder backed up at ops/cr-2026-09-25b/backup/hs-022-ps/.
...
the home city (Corona) plus areas the packet itself lists. Packet line: "Coverage: Corona / IE".
...
Follow-up 2026-09-25 PT: Scout confirmed W1-W10 packet Coverage lines were inferred from location, not sourced. Original packet line "Corona / IE / nearby OC" reduced to the home city only.
